...
public class RewardUI : MonoBehaviour
{
    ...
    public void Init(List<CardDataSO> list)
    {
        ...
        //card0.cardMagicText.text = Dic.Instance.P0CardDataSOs[list[0]].cardMagicCost.ToString();
        ...
        //card1.cardMagicText.text = Dic.Instance.P0CardDataSOs[list[1]].cardMagicCost.ToString();
        ...
        //card2.cardMagicText.text = Dic.Instance.P0CardDataSOs[list[2]].cardMagicCost.ToString();
